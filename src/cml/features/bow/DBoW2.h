...
/// ORB Vocabulary
typedef CML::Features::TemplatedVocabulary<CML::Features::FORB::TDescriptor, CML::Features::FORB>
  OrbVocabulary;

/// FORB Database
typedef CML::Features::TemplatedDatabase<CML::Features::FORB::TDescriptor, CML::Features::FORB>
  OrbDatabase;
  
/// BRIEF Vocabulary
typedef CML::Features::TemplatedVocabulary<CML::Features::FBrief::TDescriptor, CML::Features::FBrief>
  BriefVocabulary;

/// BRIEF Database
typedef CML::Features::TemplatedDatabase<CML::Features::FBrief::TDescriptor, CML::Features::FBrief>
  BriefDatabase;
