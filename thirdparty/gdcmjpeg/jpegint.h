...
struct jpeg_c_codec {
  ...
  JMETHOD(bool, need_optimization_pass, (j_compress_ptr cinfo));
  JMETHOD(void, start_pass, (j_compress_ptr cinfo, J_BUF_MODE pass_mode));
...
EXTERN(void) jinit_c_diff_controller JPP((j_compress_ptr cinfo, bool need_full_buffer));
...
EXTERN(void) jinit_d_diff_controller JPP((j_decompress_ptr cinfo, bool need_full_buffer));
