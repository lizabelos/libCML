...
typedef struct {
  ...
  /*  JMETHOD(bool, coef_compress_data, (j_compress_ptr cinfo,
  ...
  /* Entropy encoding */
  JMETHOD(bool, entropy_encode_mcu, (j_compress_ptr cinfo,
          JBLOCKROW *MCU_data));
...
typedef struct {
  ...
  JMETHOD(bool, entropy_decode_mcu, (j_decompress_ptr cinfo,
          JBLOCKROW *MCU_data));

  /* This is here to share code between baseline and progressive decoders; */
  /* other modules probably should not use it */
  bool entropy_insufficient_data;  /* set true after emitting warning */
