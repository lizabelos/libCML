...
public:
  ...
  Eigen::Matrix<float, 14, 14> H;
  Eigen::Vector<float, 14> b;
  size_t num;
...
public:
  ...
  inline void updateSSE_eighted(const CML::M128 &J0, const CML::M128 &J1,
                                const CML::M128 &J2, const CML::M128 &J3,
                                const CML::M128 &J4, const CML::M128 &J5,
                                const CML::M128 &J6, const CML::M128 &J7,
                                const CML::M128 &J8, const CML::M128 &w) {
      updateSSE_eighted(
              J0.data(),
              J1.data(),
              J2.data(),
