...
macro(add_qt_android_apk TARGET SOURCE_TARGET)
    ...
    set(QT_ANDROID_SDK_BUILDTOOLS_REVISION "30.0.0")
    ...
    if(ARG_PACKAGE_SOURCES)
        ...
        elseif(EXISTS "${ARG_PACKAGE_SOURCES}/AndroidManifest.xml")
            # custom manifest template provided
            set(QT_ANDROID_MANIFEST_TEMPLATE "${ARG_PACKAGE_SOURCES}/AndroidManifest.xml")
        endif()
    endif()
    ...
    if(NOT QT_ANDROID_APP_PACKAGE_SOURCE_ROOT)
        ...
        if(NOT QT_ANDROID_MANIFEST_TEMPLATE)
            set(QT_ANDROID_MANIFEST_TEMPLATE "${QT_ANDROID_SOURCE_DIR}/AndroidManifest.xml")
        endif()
    ...
    configure_file(${QT_ANDROID_SOURCE_DIR}/build.gradle ${QT_ANDROID_APP_BINARY_DIR}/build.gradle @ONLY)
    ...
    add_custom_target(
            ...
            COMMAND ${CMAKE_COMMAND} -E copy ${QT_ANDROID_APP_PATH} ${QT_ANDROID_APP_BINARY_DIR}/libs/${ANDROID_ABI}/lib${SOURCE_TARGET}_${ANDROID_ABI}.so
            COMMAND ${QT_ANDROID_QT_ROOT}/../gcc_64/bin/androiddeployqt
            --verbose
